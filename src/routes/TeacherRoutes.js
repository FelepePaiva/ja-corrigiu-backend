...
import { createTeacher, getAllTeacher, getTeacherById, getTeacherByIdClass, removeTeacherById } from "../controllers/TeacherController.js";
...
router.get('/teacher/:id/class', validate(idParamSchema, 'params'), authenticateJWT, getTeacherByIdClass);
